...
## Corpus Check
- 24 files · ~9,164 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 301 nodes · 739 edges · 17 communities (8 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `82950b9e`
...
1. `EventDetailComponent` - 78 edges
2. `ApiService` - 67 edges
3. `InvitationEditorComponent` - 32 edges
4. `GuestModel` - 31 edges
...
Cohesion: 0.06
Nodes (28): ApiService, CheckoutResponse, ContactPayload, EventAgendaItem, EventPayload, EventStatus, EventType, GuestAccessResponse (+20 more)
