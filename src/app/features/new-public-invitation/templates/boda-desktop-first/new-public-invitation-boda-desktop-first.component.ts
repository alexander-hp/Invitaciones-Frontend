...
@Component({
  selector: 'app-new-public-invitation-boda-desktop-first',
  templateUrl: './new-public-invitation-boda-desktop-first.component.html',
  styleUrls: ['./new-public-invitation-boda-desktop-first.component.css']
})
export class NewPublicInvitationBodaDesktopFirstComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  triggerCelebrationConfetti(): void {
    try {
      confetti({
        ...
        spread: 80,
        origin: { y: 0.6 },
        colors: ['#c59b6c', '#d4af37', '#fdfbf7', '#e8d8be', '#8c6b32']
      });
      setTimeout(() => {
        confetti({
          particleCount: 50,
  ...
  shareWhatsApp(): void {
    ...
    const text = encodeURIComponent(`¡Estás cordialmente invitado(a) a nuestra boda: ${title}! Consulta la invitación editorial aquí: ${window.location.href}`);
